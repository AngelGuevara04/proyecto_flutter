        ...
        child: historial.isEmpty
          ...
          children: [
            SizedBox(
              ...
              child: const Center(
                  child: Text('Aún no tienes pedidos finalizados',
          ...
          itemBuilder: (context, index) {
            ...
            final String horaRecibido =
            DateFormat('dd/MM/yyyy HH:mm').format(fechaRecibido);
            ...
            Color colorEstado =
            estado == 'entregado' ? Colors.green : Colors.red;
            IconData iconoEstado = estado == 'entregado'
                ? Icons.check_circle
                : Icons.cancel;
            ...
            return Card(
              ...
              child: Theme(
                ...
                child: ExpansionTile(
                  ...
                  leading:
                  Icon(iconoEstado, color: colorEstado, size: 36),
                  title: Text(
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(children: [
                            ...
                            Text(
                                'Recibido a las: ${DateFormat('HH:mm').format(fechaRecibido)}',
                                style:
                          ...
                          Row(children: [
                            ...
                            const SizedBox(width: 8),
                            Text(
                                '${estado == 'entregado' ? 'Entregado' : 'Cancelado'} a las: $horaFinal',
                                style: TextStyle(
                                    color: colorEstado,
                                    fontWeight: FontWeight.bold)),
                          ]),
                          const Divider(height: 24),
                          const Text('Entregado en:',
                              style:
